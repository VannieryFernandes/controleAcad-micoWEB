    ...
    <div class="container-fluid">
      <div class="row">
        ...
        <div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
          <h1 class="page-header">Adicionar Nova Disciplina</h1>
	      <div class="modal-body">
	      <div class="form-group">
	      
	      
	        <form class="form-group" action="DisciplinaSalvarServlet" method="get">		
				Nome da Disciplina: <input type="text" class="form-control" name="nome_disciplina"> <br>
				Area da Disciplina: <input type="text" class="form-control" name="area_disciplina"> <br>
